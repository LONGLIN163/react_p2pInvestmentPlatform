	...
	render(){
		...
		return (
			<div className="databox">
				<hr/>
				<br/>
				<b className="searchresult">Search result : {this.props.data.length}</b>
				<div className="text-right"> 
					<a onClick={()=>{this.setSetTableBoxShow(true)}}><b className="btn btn-success">Set table colums</b></a>

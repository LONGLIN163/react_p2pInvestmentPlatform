...
class Range extends Component{
    ...
    constructor({width,min,max}){
        super()
        //console.log("props",props) //----0,12000
    ...
    componentDidMount(){
            ...
            //let perbigUnitNumber = parseInt((this.props.max-this.props.min)/this.bigUnitAmount); // every big scale`s value
            //let persmallUnitNumber = parseInt(perbigUnitNumber/5); // every small scale`s value
            //console.log(perbigUnitNumber,persmallUnitNumber)
